export default function recetteMaker(recette) {
  ...
  recepeSectionTitle.className =
    "recetteContainer__detail__recepeSection__title";
  ...
  ingredientsSectionTitle.className =
    "recetteContainer__detail__ingredientsSection__title";

  //creating content
  const ingredients = document.createElement("div");
  ingredients.className =
    "recetteContainer__detail__ingredientsSection__ingredients";
  // implementing title
  ...
  recette.ingredients.forEach((element) => {
    ...
    ingredientDiv.className =
      "recetteContainer__detail__ingredientsSection__ingredients__nameQuantity";
    //name
    const ingredient = document.createElement("p");
    ingredient.className =
      "recetteContainer__detail__ingredientsSection__ingredients__nameQuantity__name";
    ingredient.innerText = element.ingredient;
    ingredientDiv.appendChild(ingredient);
    //quantity and unit
    const quantity = document.createElement("p");
    quantity.className =
      "recetteContainer__detail__ingredientsSection__ingredients__nameQuantity__quantity";
